...
# Явный путь: gunicorn/systemd могут иметь другой cwd, чем manage.py
...
# Media (картинки уроков tasks и загружаемые файлы)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# CORS: только для /api/ — внешние сайты могут вызывать API
